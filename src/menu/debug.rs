...
pub fn debug_keymap_panel(mut contexts: EguiContexts) {
    ...
    egui::TopBottomPanel::bottom("debug_keymap")
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                pair(ui, "1/2/3/4", "line-clear bursts");
                ui.add_space(16.0);
                pair(ui, "Q", "READY");
                ui.add_space(16.0);
                pair(ui, "W", "GAME OVER");
            ...
            ui.horizontal(|ui| {
                pair(ui, "R", "LEVEL 999 win");
                ui.add_space(16.0);
                pair(ui, "Up / Down", "cycle HUD preset");
                ui.add_space(16.0);
                pair(ui, "Backspace", "back to menu");
            });
        });
}
